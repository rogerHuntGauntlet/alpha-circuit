    ...
    <div className="min-h-screen bg-gradient-to-b from-[#2D0B5A] to-[#1B0B3B] flex flex-col justify-center">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-purple-100">
          ...
          <Link href="/auth/signin" className="font-medium text-[#FFE66D] hover:text-[#FF6B6B]">
            Sign in
          </Link>
        </p>
      </div>
        ...
        <div className="bg-[#1F0940]/50 py-8 px-4 shadow-xl ring-1 ring-purple-500/20 sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-purple-100">
                I agree to the{' '}
                <Link href="/terms" className="font-medium text-[#FFE66D] hover:text-[#FF6B6B]">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link href="/privacy" className="font-medium text-[#FFE66D] hover:text-[#FF6B6B]">
                  Privacy Policy
                </Link>
              </label>
            </div>
